...
local TWEEN_TRIGGER_ZONE = Vector3.new(-576.88, 312.29, -1166.93) -- Bed spawn
local THIRD_POSITION = Vector3.new(-562.56, 312.06, -1187.27)

local TWEEN_PATH = {
	Vector3.new(-572.94, 311.02, -1173.66),
	Vector3.new(-568.06, 311.03, -1180.53),
	Vector3.new(-562.56, 312.06, -1187.27),
}
...
print("Third Position: ", fmtVector3(THIRD_POSITION))
print("Tween Path:")
...
RunService.Heartbeat:Connect(function()
	...
	if (pos - THIRD_POSITION).Magnitude <= CHECK_RADIUS then
		startClicking()
	else
		stopClicking()
	end
